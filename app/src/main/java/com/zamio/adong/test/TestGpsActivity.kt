...
import com.zamio.adong.BuildConfig
...
class TestGpsActivity : AppCompatActivity() {
    ...
    private fun showMessage(text: String) {
        ...
        if (container != null) {
            Toast.makeText(this@TestGpsActivity, text, Toast.LENGTH_LONG).show()
        }
    }
    ...
    private fun showSnackbar(mainTextStringId: Int, actionStringId: Int,
        ...
        Toast.makeText(this@TestGpsActivity, getString(mainTextStringId), Toast.LENGTH_LONG).show()
    }
    ...
    private fun startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(this@TestGpsActivity,
