...
internal class GridProjectFileDetailAdapter internal constructor(context: Context, private val resource: Int, private val itemList: List<FileProject>?) : ArrayAdapter<GridProjectFileDetailAdapter.ItemHolder>(context, resource) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.name!!.text = projectItem.fileName
