 ...
 */
class FileAdapter(private val topicDetails: List<FileProject>) : RecyclerView.Adapter<FileAdapter.MyViewHolder>() {
    var onItemClick: ((FileProject) -> Unit)? = null
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.name.text = topic.fileName
        holder.unit.text = topic.fileSize.toString() + " kb"
    }
