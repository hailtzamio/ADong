 ...
 */
class ManuFactureRequestLinesAdapter(private val topicDetails: ArrayList<MenuFactureResLine>) : RecyclerView.Adapter<ManuFactureRequestLinesAdapter.MyViewHolder>() {
