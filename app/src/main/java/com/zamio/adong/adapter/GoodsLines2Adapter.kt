 ...
 */
class GoodsLines2Adapter(private val topicDetails: ArrayList<Product>) : RecyclerView.Adapter<GoodsLines2Adapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.phone.text = topic.quantityChoose.toString()
    }
