...
public class MapActivity extends AppCompatActivity
        implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, OnMapReadyCallback, GoogleMap.OnCameraIdleListener, GoogleMap.OnCameraMoveStartedListener,
...
//        stupMap();
    ...
    public void onCameraIdle() {
        ...
        mGoogleMap.clear();
        markerLayout.setVisibility(View.VISIBLE);
        Log.d("hailpt1111", "Movinggggggggggggggggg");
        try {
            new GetLocationAsync(center.latitude, center.longitude).execute();
         ...
         @Override
         public void onCameraMove() {
             Log.d("hailpt1111", "onCameraMove Movinggggggggggggggggg");
         }

         @Override
         public void onCameraMoveStarted(int i) {
             Log.d("hailpt1111", "onCameraMoveStarted Movinggggggggggggggggg");
         }
