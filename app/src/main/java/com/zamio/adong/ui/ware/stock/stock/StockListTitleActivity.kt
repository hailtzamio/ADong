...
class StockListTitleActivity : BaseActivity() {
    ...
    private fun GoodsReceivedNoteList() {
        val intent = Intent(this, GoodsReceivedNoteListActivity::class.java)
    ...
    private fun GoodsIssueList() {
        ...
        intent.putExtra(ConstantsApp.KEY_VALUES_ID, id)
        intent.putExtra(ConstantsApp.KEY_VALUES_STATUS, id)
        startActivityForResult(intent, 1000)
    }
