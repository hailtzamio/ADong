...
//        }
    ...
    private fun getData(id: Int) {
        ...
        showProgessDialog()
        RestClient().getInstance().getRestService().getManufacture(id).enqueue(object :
            Callback<RestData<ManuFactureRes>> {

            override fun onFailure(call: Call<RestData<ManuFactureRes>>?, t: Throwable?) {
                dismisProgressDialog()
            }

            override fun onResponse(
                call: Call<RestData<ManuFactureRes>>?,
                response: Response<RestData<ManuFactureRes>>?
            ) {
                dismisProgressDialog()
...
//                        }
    ...
    var lineList = ArrayList<MenuFactureResLine>()
    val mAdapter = ManuFactureRequestLinesAdapter(lineList)
...
//        }
    ...
    private fun confirm() {
        ...
        showProgessDialog()
        RestClient().getInstance().getRestService().confirmManufacture(id)
            .enqueue(object :
                Callback<RestData<JsonElement>> {
