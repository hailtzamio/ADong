...
//        setUpDebugLayout();
    ...
    private void addMarker(LatLng position, int fps, int duration) {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.busy_dot);
    ...
    private void setUpMapIfNeeded() {
        if (mMap == null) {
            SupportMapFragment  mapFrag = ((SupportMapFragment)getSupportFragmentManager().findFragmentById(R.id.frag_map));
